...
```bash
uv run --project GridExpand/5.postprocessing python GridExpand/maintenance/delete_scenario_data.py <scenario_key>
uv run --project GridExpand/5.postprocessing python GridExpand/maintenance/delete_scenario_data.py <scenario_key> --execute
```
